        ...
        <div className="min-h-screen flex items-center justify-center bg-muted/40 px-4">
            <Card className="w-full max-w-sm">
                ...
                <CardContent className="space-y-4">
                    ...
                    <Button className="w-full bg-[#F15025] hover:bg-[#F86624] cursor-pointer" onClick={SignMeUp}>
                        Signup
                    </Button>
                    ...
                    <p className="text-center text-sm text-slate-500">
                        ...
                        <button onClick={signIn} className="text-violet-600 font-semibold hover:text-violet-700 hover:underline">
                            Sign in
                        </button>
                    </p>
                </CardContent>
